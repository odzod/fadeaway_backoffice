CREATE TABLE `users`( `user_id` INT NOT NULL AUTO_INCREMENT, `user_login` VARCHAR(255), `user_pass` VARCHAR(255), `user_mail` VARCHAR(255), `user_nom` VARCHAR(255), `user_prenom` VARCHAR(255), `user_type` INT DEFAULT 0, PRIMARY KEY (`user_id`) ); 
